...
The project expects environment variables to be stored in `~/cred/media_downloader/.env`.
...
See the [meta README](https://github.com/YOUR_USERNAME/media-downloader/blob/main/meta/README.md) for detailed instructions.
